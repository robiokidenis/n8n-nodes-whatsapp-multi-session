...
exports.WhatsAppMultiSessionTrigger = void 0;
class WhatsAppMultiSessionTrigger {
    constructor() {
        this.description = {
    ...
    async webhook() {
        ...
        const includeSystemMessages = this.getNodeParameter('includeSystemMessages');
        ...
        if (messageTypeFilter !== 'all') {
            const messageType = bodyData.message_type;
        ...
        const webhookData = {
            ...
            from: bodyData.from,
            from_phone: extractPhoneNumber(bodyData.from),
            from_name: bodyData.from_name,
            to: bodyData.to,
            to_phone: extractPhoneNumber(bodyData.to),
            ...
            contact: {
                phone: extractPhoneNumber(bodyData.from),
...
exports.WhatsAppMultiSessionTrigger = WhatsAppMultiSessionTrigger;
